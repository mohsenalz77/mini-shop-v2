...
import { Sparkles, ArrowLeft, Gift, Percent } from 'lucide-react';
    ...
    <div className="w-full px-4 md:px-8 my-8 relative z-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-950 via-slate-900 to-zinc-900 border border-slate-800/60 p-6 md:p-8 flex items-center justify-between group shadow-xl">
          ...
          <div className="flex flex-col items-start gap-3 relative z-10 max-w-[65%] text-right">
          ...
          {/* آیکون یا المان گرافیکی سمت چپ بنر */}
          <div className="text-5xl md:text-6xl select-none filter drop-shadow-[0_10px_20px_rgba(244,63,94,0.2)] transform group-hover:scale-110 group-hover:rotate-3 transition duration-300 pl-2">
            📦
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-950 via-neutral-900 to-slate-900 border border-slate-800/60 p-6 md:p-8 flex items-center justify-between group shadow-xl">
          ...
          <div className="flex flex-col items-start gap-3 relative z-10 max-w-[65%] text-right">
            ...
            <p className="text-slate-400 text-[11px] md:text-xs leading-5 font-medium">
              ترکیب جادویی ساعت هوشمند و ایرپاد پرو؛ یک هدیه لوکس و به‌صرفه با <span className="text-cyan-400 font-bold">بسته‌بندی اختصاصی سیب‌شاپ</span>.
            </p>
          ...
          {/* آیکون یا المان گرافیکی سمت چپ بنر دوم */}
          <div className="text-5xl md:text-6xl select-none filter drop-shadow-[0_10px_20px_rgba(6,182,212,0.2)] transform group-hover:scale-110 group-hover:-rotate-3 transition duration-300 pl-2">
            🎁
          </div>
        </div>
