    ...
    <div className="w-full px-4 md:px-8 my-10 md:my-16 relative z-10 direction-rtl">
      ...
      <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
        {products.map((product) => (
          <div 
            key={product.id} 
            className="bg-white rounded-2xl md:rounded-3xl p-3 md:p-4 border border-slate-100 hover:shadow-[0_24px_48px_rgba(0,0,0,0.04)] hover:border-slate-200 transition-all duration-300 flex flex-col justify-between group cursor-pointer relative overflow-hidden"
          >
            <div>
              {/* باکس تصویر محصول - بهینه‌سازی ارتفاع در موبایل (h-28) */}
              ...
              {/* عنوان کالا با کنترل لاین‌کمپ و سایز فونت موبایل */}
            ...
            <div className="mt-1 pt-2 md:pt-3 border-t border-slate-100 flex flex-col gap-0.5 text-right">
              ...
              <div className="flex items-center justify-between w-full mt-0.5">
                ...
                {/* دکمه پلاس موبایل با ظاهر گرد و ظریف‌تر */}
