...
export default function ProductGrid() {
  return (
    // پدینگ دقیقاً مشابه هیرو و بقیه بخش‌ها باز شد تا از چپ و راست کاملاً هم‌تراز جلو برود
    <div className="w-full px-4 md:px-8 my-12 relative z-10">
      
      {/* هدر بخش: تمیز، مینی‌مال و بدون متن‌های زشت و طولانی قدیمی */}
      ...
      {/* گرید ۴ ستونه متقارن با حاشیه‌های نرم */}
      <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
        {products.map((product) => (
          ...
          >
            <div>
              {/* باکس تصویر محصول با لود سریع و افکت زوم ملایم */}
